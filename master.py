...
##############################
#m = replaceString("/etc/xdg/openbox/lxde-pi-rc.xml","<chainQuitKey>C-g</chainQuitKey>","<chainQuitKey>C-g</chainQuitKey>\r    <keybind key=""C-F12""><action name=""bl_toggle""><command>bl_toggle.sh</command></action></keybind>")
